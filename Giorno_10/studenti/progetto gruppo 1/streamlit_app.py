...
# ahow uploaded files in sidebar
for file_path in st.session_state.uploaded_files:
    st.sidebar.write(f"📄 {file_path.name}")

# === BUTTON FOR INITIALIZING PIPELINE ===
...
# show chat summary if pipeline is initialized
if st.session_state.pipeline:
    ...
    if chat_summary.get("total_exchanges", 0) > 0:
        ...
        # show recent topics if available
