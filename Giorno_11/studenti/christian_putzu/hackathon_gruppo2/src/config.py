...
class Config:
    ...
    AZURE_EMBEDDING_ENDPOINT = os.environ.get("AZURE_ENDPOINT_EMB", os.environ.get("AZURE_ENDPOINT"))
    AZURE_EMBEDDING_API_KEY = os.environ.get("AZURE_API_KEY_EMB", os.environ.get("AZURE_API_KEY"))
